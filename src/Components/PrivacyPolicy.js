...
export default function About() {
  ...
  <p>
    Connection Media LLP built the Connection Media app as a Free app. This
    SERVICE is provided by Connection Media LLP at no cost and is intended for
    use as is.
  </p>{" "}
  <p>
  ...
  <p>
    ...
    and Conditions, which are accessible at Connection Media unless otherwise
  ...
  <p>
    ...
    not limited to Email, Phone number, name, Date of birth, profile picture.
  ...
  <p>This policy is effective as of 2022-05-22</p>{" "}
  <p>
    <strong>Contact Us</strong>
  </p>{" "}
  <p>
    If you have any questions or suggestions about our Privacy Policy, do not
    hesitate to contact us at contact@connectionwala.com.
  </p>{" "}
